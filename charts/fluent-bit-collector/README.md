...
```shell
helm upgrade --install fluent-bit-collector oci://ghcr.io/fluent/helm-charts/fluent-bit-collector --version 1.0.6
```
...
```shell
cosign verify --certificate-oidc-issuer https://token.actions.githubusercontent.com --certificate-identity-regexp 'https://github\.com/action-stars/helm-workflows/\.github/workflows/release\.yaml@.+' --certificate-github-workflow-repository fluent/helm-charts --certificate-github-workflow-name Release ghcr.io/fluent/helm-charts/fluent-bit-collector:1.0.6
```
...
helm upgrade --install fluent-bit-collector fluent/fluent-bit-collector --version 1.0.6
```
