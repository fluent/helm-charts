...
![Version: 4.2.0](https://img.shields.io/badge/Version-4.2.0-informational?style=flat-square) ![AppVersion: 3.9.0](https://img.shields.io/badge/AppVersion-3.9.0-informational?style=flat-square)
...
```shell
helm upgrade --install fluent-operator oci://ghcr.io/fluent/helm-charts/fluent-operator --version 4.2.0
```
...
helm upgrade --install fluent-operator fluent/fluent-operator --version 4.2.0
```
...
| fluentbit.image.tag | string | `"5.0.6"` | Fluent Bit image tag renovate: datasource=docker depName=ghcr.io/fluent/fluent-operator/fluent-bit |
